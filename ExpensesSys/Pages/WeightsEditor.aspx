<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="WeightsEditor.aspx.cs" Inherits="ExpensesSys.Pages.WeightsEditor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:TextBox runat="server" ID="Cost"  class="form__field" type="input" placeholder="الكلفة المالية" />

    <label for="name" class="form__label">الكلفة المالية</label>
</div>
                     ...
                     <div class="col-4">
                         ...
                         <div class="form__group field">
     <asp:TextBox runat="server" ID="WeightText"  class="form__field" type="input" placeholder="مرحلة الانجاز" />
    ...
    <label for="name" class="form__label">مرحلة الانجاز</label>
                     ...
                     <div class="col-4">
                         ...
                         <div class="form__group field">
     <asp:TextBox runat="server" ID="Precentage"  class="form__field" type="input" placeholder="النسبة" />

    <label for="name" class="form__label">النسبة</label>
</div>
...
<div class="col-10">
                                       ...
                                       <div class="form__group field">
    <asp:DropDownList ID="UnitType"
                    class="form__field mt-2" type="text" placeholder="نوع الوحدة"
                    AutoPostBack="True"
                    runat="server">
