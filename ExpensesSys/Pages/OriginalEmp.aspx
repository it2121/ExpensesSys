<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="OriginalEmp.aspx.cs" Inherits="ExpensesSys.Pages.OriginalEmp" %>
...
OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating"
            ...
            <Columns>
                ...
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="اسم الموظف">
                    <ItemTemplate>
                ...
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="الوظيفة">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_OR1" runat="server" Text='<%#Eval("EmpJob") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="القسم">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_OR23" runat="server" Text='<%#Eval("Depart") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="العنوان">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_OR23i" runat="server" Text='<%#Eval("Address") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>      
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="الملاحظات">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_3OR23i" runat="server" Text='<%#Eval("Note") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="نوع التوظيف">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_3OR223i" runat="server" Text='<%#Eval("InvolvmentType") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
