<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="Cases.aspx.cs" Inherits="ExpensesSys.Pages.Cases" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:LinkButton  runat="server"  style="background-color: white; color: #33B3FF; font: bold; border-color:#33B3FF" text="اضافة دعوة جديدة"
        
         
         data-target="modal-js-example"
                                 onclick="GoToNewItem"

                        class="js-modal-trigger button is-fullwidth  align align-content-center  button is-ou">اضافة دعوى جديدة 
...
OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating"
            ...
            <Columns>
                ...
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="تاريخ الدعوة">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_RecID" runat="server" Text='<%#Eval("CaseDate") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField> 
                 <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="رقم الدعوة">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_33Quant1" runat="server" Text='<%#Eval("CaseNumber") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField> 
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="قرار الحكم">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_Qudgdant" runat="server" Text='<%#Eval("CaseResultes") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>      
                ...
                <asp:TemplateField  ItemStyle-HorizontalAlign="Center" >
                    <ItemTemplate>
                        <asp:Button 
                            ...
                            ID="UnitDocks" runat="server"   Font-Size="Medium" Text="المستمسكات" CommandArgument='<%#Eval("ID") %>' CommandName="Docks" />
                    </ItemTemplate>
