<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="PeojectUnitEditor.aspx.cs" Inherits="ExpensesSys.Pages.PeojectUnitEditor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:TextBox runat="server" ID="NameOfUnit"  class="form__field" type="input" placeholder="اسم الوحدة" />

    <label for="name" class="form__label">اسم الوحدة</label>
</div>
</div>
</div>     
      <div class="row m-4" >
    ...
    <label for="name" class="form__label">نوع الوحدة</label>
                   ...
                   <div class="col-md-12 text-center ">
                                     ...
                                     <div class="form__group field">
     <asp:TextBox runat="server" ID="IDOFUnitIfExist"  class="form__field" type="input" placeholder="معلومات اضافية" />

    <label for="name" class="form__label">معلومات اضافية</label>
</div>
</div>
</div>
