<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="LAWContracts.aspx.cs" Inherits="ExpensesSys.Pages.LAWContracts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:LinkButton  runat="server"  style="background-color: white; color: #33B3FF; font: bold; border-color:#33B3FF" text="اضافة دعوة جديدة"
         ...
         data-target="modal-js-example"
                        ...
                        class="js-modal-trigger button is-fullwidth  align align-content-center  button is-ou">اضافة عقد جديدة 
...
OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating"
            ...
            <Columns>
                ...
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="تاريخ العقد">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_RecID" runat="server" Text='<%#Eval("ContractDate") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField> 
                 <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="نوع العقد">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_33Quant1" runat="server" Text='<%#Eval("ContractType") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField> 
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="الجهة المتعاقد معها">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_Qudgdant" runat="server" Text='<%#Eval("ContractingWithParty") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>   
