<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="ItemsEditor.aspx.cs" Inherits="ExpensesSys.Pages.ItemsEditor" %>
     ...
     <asp:LinkButton  runat="server"  style="background-color: white; color: #33B3FF; font: bold; border-color:#33B3FF" text="الرجوع"
        ...
        <div class="panel-block">
            ...
            <p class="control has-icons-left">
                <asp:TextBox runat="server" ID="ItemName" class="input is-info" type="text" placeholder="اسم المادة" />
      ...
      <div class="row m-2">
              ...
              <asp:Button runat="server" ID="CreateBtn" style="width:20em" OnClick="CreateItem" class="button is-primary text-center " Text="اضافة مادة جديدة"></asp:Button>
          </div>
...
<hr />    
    ...
    <script>function confirmation() {
            return confirm("هل انت متاكد, سوف تحذف المادة بشكل نهائي?");
        }</script>
