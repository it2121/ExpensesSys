...
<script type="text/javascript">
 ...
 <asp:UpdatePanel ID="UpdatePanelDates" runat="server" style="width:100%;" UpdateMode="Conditional" >
            ...
            <hr />
             <div class="row m-2">
                               <asp:Button runat="server" ID="Button5" style="width:100%; margin-top:1.6rem;"  OnClick="CalclateAllTables" class="button is-primary text-center" Font-Size="Larger" Text="حساب"></asp:Button>
