<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="EmpMan.aspx.cs" Inherits="ExpensesSys.Pages.EmpMan" %>
...
OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating"
            ...
            <Columns>
                ...
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="المرتب">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_OR2" runat="server" Text='<%#Eval("EmpSalary") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
