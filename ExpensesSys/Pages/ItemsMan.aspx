<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="ItemsMan.aspx.cs" Inherits="ExpensesSys.Pages.ItemsMan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:LinkButton  runat="server"  style="background-color: white; color: #33B3FF; font: bold; border-color:#33B3FF" text="اضافة مادة جديدة"
        
         
         data-target="modal-js-example"
                                 onclick="GoToNewItem"

                        class="js-modal-trigger button is-fullwidth  align align-content-center  button is-ou">اضافة مادة جديدة 
           ...
           <%--      <asp:TemplateField  Visible="true" HeaderText="Provider">
                    ...
                    <ItemTemplate>
                        <asp:Button 
                            ...
                            ID="btn_Edit" runat="server" Text="تعديل اسم المادة" CommandName="Edit" />
                    </ItemTemplate>
