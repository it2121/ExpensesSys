<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="UnitTechInfo.aspx.cs" Inherits="ExpensesSys.Pages.UnitTechInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <article class="panel is-info" style="background-color: white;padding-bottom:2em;">
        <p class="panel-heading text-center" style="background-color:#3399ff;">تحديث المعلومات الفنيى الخاصة بالوحدات<i class="fa-solid fa-file-invoice-dollar"></i></p>
