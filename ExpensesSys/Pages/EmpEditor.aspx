<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="EmpEditor.aspx.cs" Inherits="ExpensesSys.Pages.EmpEditor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <label for="name" class="form__label">الوظيفة</label>
                ...
                <div class="col-4">
                         ...
                         <div class="form__group field">
     <asp:TextBox runat="server" ID="EmpSal"  class="form__field" type="input" placeholder="المرتب" />

    <label for="name" class="form__label">المرتب</label>
</div>
...
<%--              <p class="control has-icons-left">
                <asp:TextBox runat="server" ID="EmpJob" class="input is-info" type="text" placeholder="الوظية" />
      ...
      <div class="row m-2">
              ...
              <asp:Button runat="server" ID="CreateBtn" style="width:20em" OnClick="CreateItem" class="button is-primary text-center " Text="اضافة موظف جديد"></asp:Button>
          </div>
...
<hr />    
    ...
    <script>function confirmation() {
            return confirm("هل انت متاكد, سوف تحذف بيانات الموظف نهائياً?");
        }</script>
