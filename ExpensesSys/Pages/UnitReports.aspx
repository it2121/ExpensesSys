<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="UnitReports.aspx.cs" Inherits="ExpensesSys.Pages.UnitReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <article class="panel is-info" style="background-color: white;">
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <asp:Panel ID="WithdrowPartyPanel" Width="95%" HorizontalAlign="Center" CssClass="container-fluid" BorderColor="LightGreen" BorderStyle="Solid" BorderWidth="0.2em" runat="server" Visible="true">
                    <div class="row  m-4">
                        <asp:CheckBox runat="server" ID="PrjectNameCheck" class="input is-info border-0 checkbox " Width="100%" Checked="false" AutoPostBack="true" OnCheckedChanged="ChckedChangedProjectName" type="text" Text="تحديد مشروع" TextAlign="Right" placeholder="تحديد مشروع" />
                    </div>
            ...
            <div class="col-4">
                ...
                <asp:Panel ID="EmpPanel" Width="95%" HorizontalAlign="Center" CssClass="container-fluid" BorderColor="LightGreen" BorderStyle="Solid" BorderWidth="0.2em" runat="server" Visible="true">
                    <div class="row  m-4">
        ...
        <div class="col-4">
                ...
                <asp:Panel ID="LoanPanel" Width="95%" HorizontalAlign="Center" CssClass="container-fluid" BorderColor="LightGreen" BorderStyle="Solid" BorderWidth="0.2em" runat="server" Visible="true">
                    <div class="row  m-4">
        ...
        <div class="col-4 mt-3">
                ...
                <asp:Panel ID="WarnPanel" Width="95%" HorizontalAlign="Center" CssClass="container-fluid" BorderColor="LightGreen" BorderStyle="Solid" BorderWidth="0.2em" runat="server" Visible="true">
                    <div class="row  m-4">
    ...
    <label for="name" class="form__label">المقدار</label>
        ...
        <div style="background-color: #f2fff3; width: 100%;" class="text-center">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-4  text-center ">
                    <asp:Label runat="server" ID="RecevedSum" Font-Bold="true" ForeColor="DarkCyan" Text="0 IQD مجموع المبالغ المستلمة"></asp:Label>
                  ...
                  <div class="col-md-4  text-center ">
                            ...
                            <asp:Label runat="server" ID="PendningAcordingToCompStage" ForeColor="DarkOrange" Font-Bold="true" Text="0 IQD مجموع المبالغ المطلوبة حسب مرحلة الانجاز "></asp:Label>
                        ...
                        <div class="col-md-4  text-center ">
                            ...
                            <asp:Label runat="server" ID="AllRemAmount" ForeColor="DarkOrange" Font-Bold="true" Text="0 IQD مجموع المبالغ المتبقية"></asp:Label>
       ...
       <div class="col-6 text-center ">
                            ...
                            <asp:Label runat="server" ID="EmpCount" ForeColor="DarkOrange" Font-Bold="true" Text="عدد الموظفين"></asp:Label>
                            ...
                            <asp:Label runat="server" ID="NonEmpCount" ForeColor="DarkOrange" Font-Bold="true" Text="عدد الغير موظفين"></asp:Label>
                            ...
                            <asp:Label runat="server" ID="LoanCount" ForeColor="DarkOrange" Font-Bold="true" Text="عدد المقترضين"></asp:Label>
                        ...
                        <div class="col-6 text-center ">
                            ...
                            <asp:Label runat="server" ID="NonLoanCount" ForeColor="DarkOrange" Font-Bold="true" Text="عدد الغير مقترضين"></asp:Label>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center ">
                            ...
                            <asp:Label runat="server" ID="TotalCount" ForeColor="DarkOrange" Font-Bold="true" Text="العدد الكلي"></asp:Label>
