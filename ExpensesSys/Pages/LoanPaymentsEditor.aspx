<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="LoanPaymentsEditor.aspx.cs" Inherits="ExpensesSys.Pages.LoanPaymentsEditor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:TextBox runat="server" ID="PaymentNumber"  class="form__field" type="input" placeholder="رقم الدفعة" />
    ...
    <label for="name" class="form__label">رقم الدفعة</label>
                    ...
                    <div class="col-6">
                         ...
                         <div class="form__group field">
     <asp:TextBox runat="server" ID="RcvdDate"  class="form__field" type="input" placeholder="تاريخ الدفعة" />

    <label for="name" class="form__label">تاريخ الدفعة</label>
</div>
            ...
            <div class="row m-2">
                ...
                <div class="col-12">
                         ...
                         <div class="form__group field">
     <asp:TextBox runat="server" ID="PaymentAmount"  class="form__field" type="input" placeholder="مقدار الدفعة الكامل" />
