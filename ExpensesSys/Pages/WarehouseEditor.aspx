<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="WarehouseEditor.aspx.cs" Inherits="ExpensesSys.Pages.WarehouseEditor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:LinkButton  runat="server"  style="background-color: white; color: #33B3FF; font: bold; border-color:#33B3FF" text="اضافة قيد سحب جديد"
         ...
         data-target="modal-js-example"
                                 onclick="GoToNewItemDirectWithdraw"

                        class="js-modal-trigger button is-fullwidth  align align-content-center  button is-ou">اضافة قيد سحب مباشر جديد 
...
OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating"
            ...
            <Columns>
                ...
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="العملية">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_Quant" runat="server" Text='<%#Eval("ActionType") %>' Font-Bold="true" Font-Size="Medium"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>   
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="الكمية">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_Count" runat="server" Text='<%#Eval("Quant") %>' Font-Bold="true" Font-Size="Medium"></asp:Label>
                    </ItemTemplate>
