<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="LoanPayments.aspx.cs" Inherits="ExpensesSys.Pages.LoanPayments" %>
...
OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating"
            ...
            <Columns>
                ...
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="رقم الدفعة">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_Qudgdant" runat="server" Text='<%#Eval("PaymentNumber") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>      
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="مبلغ الدفعة الكامل">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_33Quant1" runat="server" Text='<%#Eval("PaymentAmount") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>      
                ...
                <asp:TemplateField   ItemStyle-HorizontalAlign="Center" Visible="true" HeaderText="تاريخ الدفع">
                    <ItemTemplate>
                        <asp:Label  ID="lbl_Quant1WithdrowParty" runat="server" Text='<%#Eval("RcvdDate") %>' Font-Bold="true" Font-Size="Large"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>      
