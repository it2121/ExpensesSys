        ...
        public CurrencyInfo(Currencies currency)
        {
            switch (currency)
            {
                case Currencies.Syria:
                    ...
                    EnglishCurrencyName = "Iraqi Denar";
                    EnglishPluralCurrencyName = "Iraqi Denar";
                    EnglishCurrencyPartName = "Dinar";
                    EnglishPluralCurrencyPartName = "Dinar";
                    Arabic1CurrencyName = "دينار";
                    Arabic2CurrencyName = "ديناران";
                    Arabic310CurrencyName = "دنانير";
                    Arabic1199CurrencyName = "دينار";
